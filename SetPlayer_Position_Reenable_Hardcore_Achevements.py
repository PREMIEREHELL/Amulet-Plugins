...
class SetPlayer(wx.Panel, DefaultOperationUI):
    ...
    def __init__(
        ...
        if self.platform == "java":
            self.gm_mode = wx.RadioBox(self, label='Set Gamemode', choices=list(self.listRadiojava.keys()), style=wx.RA_SPECIFY_ROWS | 1)
    ...
    def getPlayerData(self, pl):
        ...
        if self.platform == "bedrock":
           ...
           # data = self.world.level_wrapper.get_raw_player_data(pl)
            #print(self.world.level_wrapper.root_tag, "java")
            # print(self.world.players.all_player_ids())
            # print(pl)
    ...
    def loadData(self, _):
        ...
        self.world.level_wrapper.root_tag['hasBeenLoadedInCreative'] = TAG_Byte(0)
        self.world.level_wrapper.root_tag['commandsEnabled'] = TAG_Byte(0)
        self.world.level_wrapper.root_tag['GameType'] = TAG_Int(0)

        self.world.level_wrapper.root_tag.save()
       # print(self.world.level_wrapper.root_tag)
    pass
