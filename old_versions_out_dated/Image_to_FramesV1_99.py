...
class SetFrames(wx.Panel, DefaultOperationUI):
    ...
    def __init__(
        ...
        self.buttonGrid = wx.GridSizer(1, 0, 0)
    ...
    def imageP(self, imagedata):
        ...
        self.box.Add(self.grid1)
        self.box.Add(self.grid2)
    ...
    def onAddPicture(self, event):
        ...
        if self._Final_operations.GetValue() != "" and self.mapveiwing != 1:
    ...
    def boxSetter(self, uuid, fRotation, ItemId, ID, box_dim, facing, pntd):
        ...
        if self._Final_operations.GetValue() != "":
            theBlockData = self.jgeterseter()
...
export = dict(name="#A_Image to Frames, Plugin V1.99b", operation=SetFrames)  # by PreimereHell
