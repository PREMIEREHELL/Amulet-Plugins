...
class SetBlock(wx.Panel, DefaultOperationUI):
    ...
    def Onmsgbox(self):
        wx.MessageBox("You need to have valid snbt data in the Text field.\n This field cant be Empty.", "Something Went Wrong", wx.OK | wx.ICON_INFORMATION)
    ...
    def _run_operation(self, _):
        ...
        if "BlockEntity" in data:
            ...
            blockEntity = None
        historyData = '{:%Y-%b-%d %H:%M:%S}'.format(datetime.datetime.now()) + "~~" + str(block) + "|" + str(blockEntity).replace('\n\n\n', '') + "\n"
