...
class SetFrames(wx.Panel, DefaultOperationUI):
    ...
    def imageP(self, imagedata):
        ...
        self.grid1.Add(self.AddSelf, 0, wx.LEFT ,  2)
        self.box.Add(self.grid2, 0, wx.LEFT , 110)
        self.box.Add(self.grid1, 0,wx.LEFT | wx.BOTTOM , 20)
...
export = dict(name="#A_Image to Frames, Plugin V2.00b", operation=SetFrames)  # by PreimereHell
